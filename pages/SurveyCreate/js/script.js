...
// фичи (новые фичи tg ярлык, геолокация, свой экран загрузки)
// маркетплейс для сборки мебели (будущее)
// интерфейс для сборщика видит свои заказы и прокликать свои (календарь, заказы, выходные дни)